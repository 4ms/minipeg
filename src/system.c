...
void enable_gpio_rcc(GPIO_TypeDef* port) {
	if (port==(GPIO_TypeDef*)(0x00000000)) return;
	#ifdef GPIOA
	else if (port==GPIOA && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOA)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA);
	#endif
	#ifdef GPIOB
	else if (port==GPIOB && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOB)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOB);
	#endif
	#ifdef GPIOC
	else if (port==GPIOC && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOC)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOC);
	#endif
	#ifdef GPIOD
	else if (port==GPIOD && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOD)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOD);
	#endif
	#ifdef GPIOE
	else if (port==GPIOE && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOE)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOE);
	#endif
	#ifdef GPIOF
	else if (port==GPIOF && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOF)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOF);
	#endif
	#ifdef GPIOG
	else if (port==GPIOG && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOG)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOG);
	#endif
	#ifdef GPIOH
	else if (port==GPIOH && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOH)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOH);
	#endif
	#ifdef GPIOI
	else if (port==GPIOI && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOI)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOI);
	#endif
	#ifdef GPIOJ
	else if (port==GPIOJ && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOJ)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOJ);
	#endif
	#ifdef GPIOK
	else if (port==GPIOK && !LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_GPIOK)) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOK);
	#endif
}

void enable_adc_rcc(ADC_TypeDef *ADCx) {
	if (ADCx==(ADC_TypeDef *)(0x00000000)) return;
	#ifdef ADC1
	if (ADCx==ADC1) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_ADC12);
	#endif
	#ifdef ADC2
	else if (ADCx==ADC2) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_ADC12);
	#endif
	#ifdef ADC3
	else if (ADCx==ADC3) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_ADC345);
	#endif
	#ifdef ADC4
	else if (ADCx==ADC4) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_ADC345);
	#endif
	#ifdef ADC5
	else if (ADCx==ADC5) LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_ADC345);
	#endif
}

void enable_dma_rcc(DMA_TypeDef *DMAx) {
	if (DMAx==(DMA_TypeDef *)(0x00000000)) return;
	#ifdef DMA1
...
void enable_tim_rcc(TIM_TypeDef *TIM) {
	...
	#endif
	#ifdef TIM20
	if (TIM==TIM20) LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_TIM20);
	#endif
}
...
uint8_t tim_periph_to_num(TIM_TypeDef *TIM) {
	if (TIM==(TIM_TypeDef *)(0x00000000)) return 0;
	#ifdef TIM1
	...
	#endif
	#ifdef TIM18
	else if (TIM==TIM18) return 18;
	#endif
	#ifdef TIM19
	else if (TIM==TIM19) return 19;
	#endif
	#ifdef TIM20
	else if (TIM==TIM20) return 20;
	#endif
	else return 0;
}
